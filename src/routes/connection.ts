  ...
  console.log('🛣️ Registering connection routes...');
    ...
    fastify.get('/test', async (request: FastifyRequest, reply: FastifyReply) => {
        ...
        availableEndpoints: [
            ...
            'GET /api/connections/debug - Debug connections table',
     ...
     // GET /api/connections/debug - Debug endpoint (add this before stats)
    fastify.get('/debug', ConnectionController.debugConnectionsTable);
    console.log('✅ Debug connections route registered');
